...
- ⚠️ **ประเด็นสถาปัตยกรรม (Roger ยก 2026-08-25):** สับสน super-admin (คุมทั้งระบบ/หลายแบรนด์) vs brand-admin (คุมหลังร้านแบรนด์เดียว) — ต้องออกแบบแยกบทบาท/หน้าจอ super-admin ใหม่ · **รอถกแบบ+ตัดสินใจ**
- ▶️ **ถัดไป (เลือกได้):** ออกแบบ super-admin ใหม่ · Campaign/ภารกิจ (Phase 4 ต่อ) · dogfood/pilot

...
1. **ก่อนเขียน/แก้อะไร**: อ่าน **`BACKLOG.md`** (งานค้างจริง — หยิบจากนี่) + `ARCHITECTURE.md` +
   ไฟล์นี้ แล้ว **อธิบายก่อนลงมือ** ว่าจะวางตรงไหน เข้ากับโครงเดิมยังไง ข้ามเส้นห้ามข้ามไหม —
   ห้ามสร้างเสร็จก่อนค่อย audit · **อย่าเชื่อ ROADMAP/STATUS/CHECKLIST ว่าเหลืออะไร** (เป็น done-log)
